<div class="page">
  ...
  <div class="header" style="margin-bottom:5em; ">
    ...
    <div class="container">
     <a href="<?=site_url()?>"><img class="logotopo"  src="<?=site_url()?>resources/site/images/explologo2018br.png"></a><!-- <p style="color:#4f81bd;font-size: 5em;">2018</p> -->
     ...
     <div id=" animated fadeInRight" style="text-align:center;width: 100%;">
      <img class="aptopo"  src="<?=site_url()?>resources/site/images/logos2en.png">
    </div>
...
Contact us for more information</b></p>
      ...
      <div class="register-now">
        <a href="#form" class="button botao1en" style="background: #4f81bd;border:3px solid #385d8a;">ENROLLMMENT</a>
...
<div class="topics" style="margin-top: 5em;">
  <div class="container">
    ...
    <h3><strong>Event´s Presentation  :</strong><br />EXPLO TECH 2018 - Exposition and Congress </h3>
     ...
     <!-- Trigger Modal. -->
        ...
        <div class="modal" id="platina">
          ...
          <div class="modal-box">
            ...
            <ul>
              <li>Graphic materials (poster, invitations, visitation Guide, electronic catalogue of EXPLO TECH, Congress Schedule, advertisements in specialized magazines, e-mails marketing and folders).</li>
              <li>Entrance portico, stage scenery of the main auditorium, external advertisement pieces.</li>
              <li>Congress briefcase.</li>
          ...
          <p>
            <ul>
              <li>Advertisement page in the official congress schedule. (material to be provided by the sponsor)
              ...
              <li>Display of institutional video lasting 1 minute at the opening of Congress (video provided by the sponsor).</li>
              ...
              <li>• 40% discount in the congress enrollment fees for employees.</li>
            </ul>
          </p>
  ...
  <div class="modal" id="ouro">
    ...
    <div class="modal-box">
      ...
      <div class="modal-body">
       ...
       <p>
        <ul>
          <li>Graphic materials (posters, invitations, visitation Guide, electronic catalogue of EXPLO TECH, Congress Schedule, advertisements in specialized magazines, e-mails marketing and folders). </li>
          <li>Entrance portico, stage scenery of the main auditorium, external advertisement pieces.</li>
          <li>Congress briefcase.</li>
        </ul>
      </p>
      ...
      <p>
        <ul>
          <li>Advertisement page in the official congress schedule.</li>
          <li>Logo in the event´s website, with link to the company's website.</li>
          <li>Promotional material from the company in the folders distributed to all participants registered in the event (material to be provided by the sponsor).</li>
          <li>30% discount in the congress enrollment fees for employees.</li>
        </ul>
      </p>
      <p style="color:red;margin-top: 3em;">Technical Lecture:</p>
      <p>
...
<div class="modal" id="prata">
  ...
  <div class="modal-box">
    ...
    <div class="modal-body">
      ...
      <p>
        <ul>
          <li>Advertisement page in the official congress schedule. (material to be provided by the sponsor).</li>
          <li>Logo on the event´s website, with link to the company's website.</li>
          <li>20% discount in the congress enrollment fees for employees.</li>
        </ul>
      </p>
      <br />
      <button class="close-modal">CLOSE</button>
...
<div class="modal" id="bronze">
  ...
  <div class="modal-box">
    ...
    <div class="modal-body">
      ...
      <p>
        <ul>
          <li>Advertisement page in the Congress Schedule (the advertisement will be provided by the sponsor).</li>
          <li>Logo on the event´s website, with link to the company's website.</li>
          <li>10% discount in the congress enrollment fees for employees.</li>
        </ul>
      </p>
      <br />
      <button class="close-modal">CLOSE</button>
