<div class="page">
  ...
  <div class="header" style="margin-bottom:5em; ">
    ...
    <div class="container">
     <a href="<?=site_url()?>Sites/ingles"><img class="logotopo"  src="<?=site_url()?>resources/site/images/explologo2018.png"></a><!-- <p style="color:#4f81bd;font-size: 5em;">2018</p> -->
     <!-- <p style="color:#4f81bd;font-size: 5em;">2018</p> -->

     <p class="subtitle " id="subtitulo" style="color:#000;" ><b>CONGRESSO E EXPOSIÇÃO INTERNACIONAL DE TECNOLOGIA, ENGENHARIA, APLICAÇÕES, EQUIPAMENTOS, LOGÍSTICA, PRODUTOS E SERVIÇOS DO SETOR DE EXPLOSIVOS E CONGÊNERES</b></p>

     <div id=" animated fadeInRight" style="text-align:center;width: 100%;">
      <img class="aptopo"  src="<?=site_url()?>resources/site/images/logos2.png">
    </div>
    <div class="fixtudo" style="margin-top: 10em;">
      <div class="when">
        ...
        <div >
          ...
          <p style="color:#000;"><span >16 e 17 de outubro de 2018</span></p>
        </div>
      ...
      <div class="register-now">
        <a href="#form" class="button botao1" style="background: #4f81bd;border:3px solid #385d8a;">Quero Participar</a>
        <a href="#location" class="button botao2" style="background: #1d7aa9;border:3px solid #385d8a;">Como Participar</a>
      </div>
    </div>
...
<div class="topics" style="margin-top: 5em;">
  <div class="container">
    ...
    <h3><strong>Apresentação Evento :</strong><br />EXPLO TECH 2018 – Congresso e Exposição </h3>

    <p>É o evento oficial do setor de explosivos representada pela <b>ABIMEX</b> (Associação Brasileira das Indústrias de Materiais Explosivos e Agregados).</p>
    <p>Realizada em São Paulo, o <b>EXPLO TECH 2018</b> – Exposição e Congresso vêm para atender a demanda do mercado, por um fórum especializado para debater os temas centrais do setor de explosivos e ao mesmo tempo reunir num só espaço as melhores soluções para mineração, desmonte de rochas, segurança na indústria automobilística, pirotecnia, propulsão e demais aplicações.
    </p>
...
<div class="bullets">
  ...
  <div>
    ...
    <p>Por suas caraterísticas exclusivas, a <b>EXPLO TECH 2018</b> - Exposição e Congresso 2018 é a oportunidade para empresas fornecedoras construírem e consolidarem relacionamentos com um mercado em constante crescimento.</p>
    <p>O Congresso será formado por painéis, abordando temas estratégicos e palestras técnicas apresentadas por empresas patrocinadoras e parceiras do <b>SINDEX e ABIMEX</b>.</p>
...
<div class="registration">
  <div class="container">
    ...
    <h3 id="form">Entre em Contato</h3>
    ...
    <div class="price">
      ...
      <div>
        ...
        <h4><span style="font-size: 0.6em;"><i class="fa fa-phone" aria-hidden="true"> 55 11 3073-1020 / 55 11 3073-1055</i> <i class="fa fa-whatsapp" aria-hidden="true"> 55 11 94088 2006</i> <br/><i class="fa fa-envelope-o" aria-hidden="true"> contato@exploexpo.com</i><br/> <i class="fa fa-globe" aria-hidden="true"> www.exploexpo.com</i> </span>
        </div>

        <div>

          <p class="amount"><i class="fa fa-map-marker" aria-hidden="true"></i></p>
          <h4><span style="font-size: 0.7em;" >Endereço:</span></h4>
          <p><span>Av. 09 de Julho, 5143  cj. 22 Jardim Paulistano  CEP: 01407-906 São Paulo SP  Brasil</span></p>
        ...
        <div class="modal" id="platina">
          ...
          <div class="modal-box">
            ...
            <div class="modal-body">
              ...
              <ul>
                <li>Materiais gráficos (cartaz, convites, guia de visitação, catálogo eletrônico da EXPLO TECH, caderno programa do Congresso, anúncios nas revistas especializadas, e-mails marketing e folders).
                </li>
            ...
            <p>
              <ul>
                <li>Inserção de uma página de anúncio em uma das capas do caderno programa do Congresso ou página dupla (o anúncio será fornecido pelo patrocinador).
                </li>
                <li>Logomarca no site do evento, com link para o site da empresa.</li>
                <li>Exibição de vídeo institucional com duração de 1 minuto na abertura do Congresso (vídeo fornecido pelo patrocinador).
                </li>
                <li>Inserção de material promocional da empresa na pasta à ser distribuída à todos os participantes inscritos no Congresso (material fornecido pelo patrocinador).
                </li>
                <li>Participação de um Executivo da Empresa Patrocinadora na Coletiva de Imprensa do Evento.
                </li>
                <li>Desconto de 40% no valor das inscrições do Congresso.
                </li>
              </ul>
            </p>
      ...
      <div class="modal-box">
        ...
        <div class="modal-body">
         ...
         <p>
          <ul>
            <li>
              Materiais gráficos (cartazes, convites, guia de visitação, catálogo eletrônico da EXPLO TECH, caderno programa do Congresso, anúncios nas revistas especializadas, e-mails marketing e folders).
        ...
        <p>
          <ul>
            <li>Inserção de uma página de anúncio  no caderno programa do Congresso (o anúncio será fornecido pelo patrocinador).
            </li>
            <li>Logomarca no site do evento, com link para o site da empresa.</li>
            <li>Inserção de material promocional da empresa na pasta a ser distribuída à todos os participantes inscritos no Congresso (material fornecido pelo patrocinador).</li>
            <li>Desconto de 30% no valor das inscrições do Congresso.</li>
          </ul>
        </p>
        <p style="color:red;margin-top: 3em;">Palestra Técnica:
        </p>
  ...
  <div class="modal" id="prata">
    ...
    <div class="modal-box">
      ...
      <div class="modal-body">
        ...
        <p>
          <ul>
            <li>Inserção de uma página de anúncio de 1\2 página no  caderno programa do Congresso (o anúncio será fornecido pelo patrocinador). </li>
            <li>Logomarca no site do evento, com link para o site da empresa.</li>
            <li>Desconto de 20% no valor das inscrições do Congresso.
            </li>
          </ul>
        </p>
        <br />
  ...
  <div class="modal" id="bronze">
    ...
    <div class="modal-box">
      ...
      <div class="modal-body">
        ...
        <p>
          <ul>
            <li>Materiais gráficos (cartaz, convites, guia de visitação, catálogo eletrônico da EXPLO TECH, caderno programa do Congresso, anúncios nas revistas especializadas, e-mails marketing e folders).</li>
            <li>Pórtico de entrada, cenário do palco do auditório principal, peças de divulgação externa, sinalização interna.
</li>
        ...
        <p>
          <ul>
            <li>Inserção de uma página de anúncio de 1\4 página no  caderno programa do Congresso (o anúncio será fornecido pelo patrocinador).
</li>
            <li>Logomarca no site do evento
</li>
            <li>Desconto de 20% no valor das inscrições do Congresso.</li>
          </ul>
        </p>
        <br />
        <button class="close-modal">FECHAR</button>
...
<div class="info" style="margin-top: 18em;text-align: center;">
 ...
 <div class="" style="width: 100%;text-align: center;">
  ...
  <?php foreach ($imagens2 as $i2): ?>
    <img class="imgfix" src="<?=site_url().$i2['imagem']?>" style="max-width: 100%;max-height: 100px;margin-bottom: 1em;">
  <?php endforeach ?>
</div>  
</div>
<!-- info ends! -->
    ...
    <div class="info" style="margin-top: 10em;text-align: center;padding-bottom: 4em;padding-top: 2em;">
     ...
     <div class="address animated fadeInRight" style="width: 100%;text-align: center;" >
      ...
      <?php foreach ($imagens3 as $i3): ?>
        <img class="imgfix " src="<?=site_url().$i3['imagem']?>" style="max-width: 100%;max-height: 100px;">
      <?php endforeach ?>
