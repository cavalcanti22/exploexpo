        ...
        <div class="row">
          ...
          <center>
           <a href="#" target="_blank"> 
            <img class="esquerda"  src="<?=site_url()?>resources/site/images/logo_explo.png">
          </a>

          <a href="" target="_blank">
            <img class="direita"  src="<?=site_url()?>resources/site/images/ISSE_2018.png">
          </a>

      <!--   <a href="https://issuu.com/regis.zam/docs/revista_abimex_news" target="_blank">
          <img class="revista"  src="<?=site_url()?>resources/site/images/revista.png">
        </a> -->
      </center>
